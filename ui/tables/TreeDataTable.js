import {tbody, tr, td, a, each, set, trigger, span, runEitherOr, dynamicFragment, state} from "../../trio.js";
...
export function nodeState(expandCommand, model) {
    return state(false).observeChanges(runEitherOr(expandCommand, () => model.set({content: [], first: true, last: true})))
}
